namespace GymMSWF
{
	partial class PaymentForm
	{
		...
		private void InitializeComponent()
		{
			...
			paymentData.ColumnHeadersHeight = 40;
			...
			paymentData.RowHeadersWidth = 51;
			paymentData.RowTemplate.Height = 30;
			paymentData.Size = new Size(1218, 380);
			paymentData.TabIndex = 1;
			paymentData.ThemeStyle.AlternatingRowsStyle.BackColor = Color.FromArgb(49, 52, 67);
			paymentData.ThemeStyle.AlternatingRowsStyle.Font = null;
			paymentData.ThemeStyle.AlternatingRowsStyle.ForeColor = Color.White;
			paymentData.ThemeStyle.AlternatingRowsStyle.SelectionBackColor = Color.Empty;
			paymentData.ThemeStyle.AlternatingRowsStyle.SelectionForeColor = Color.Empty;
			...
			paymentData.ThemeStyle.HeaderStyle.Height = 40;
			...
			SearchTxt.Location = new Point(224, 13);
			...
			Addbtn.Location = new Point(1080, 13);
			Addbtn.Name = "Addbtn";
			...
			Updatebtn.Location = new Point(895, 12);
			...
			Deletebtn.Location = new Point(707, 12);
